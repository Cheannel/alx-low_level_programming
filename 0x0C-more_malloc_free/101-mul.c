 ...
 * description: Creates an array of chars and initializes it with
 ...
 * description: iterates through a string of numbers containing
 * leading zeroes until it hits a non-ero number
 ...
 * description: multiplies a string of numbers by a single digit.
...
/**
 * main - main block
 * description: a program that multiplies two positive
 * @argc: counts the number of arguments passed to the command line
